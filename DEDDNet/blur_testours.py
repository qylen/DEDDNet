...
parser.add_argument('-opt', type=str, default='/home/zjc/dual_pixel/BaMBNet-main/option/test/COC_Dataset_Test.yaml', help='Defocus Deblur: Path to option ymal file.')
